const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=c47e55d54eb3cb601a2de0b71c34823d";
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    document.getElementById("tempvalue").textContent = Math.round(jsObject.main.temp);
...
const forecastapiURL =
  "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=c47e55d54eb3cb601a2de0b71c34823d";
